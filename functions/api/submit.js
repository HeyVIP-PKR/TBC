...
function buildRiskIssueDynamicMessage({ brandName, fields, fieldMap, reporter }) {
  ...
  // Remove Bank Account, Others Issues) use "Issue Description" instead
  // of "Remark" and never collect fieldMap.remark at all, so this used
  // to unconditionally print an empty "Remark: -" line even when the
